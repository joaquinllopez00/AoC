...
public class Main {
    public static void main(String[] args) {
        ...
        int part1Result = day02.solvePart1();
        System.out.println("Part 1 - Number of safe reports: " + part1Result);  // Should be 2

        int part2Result = day02.solvePart2();
        System.out.println("Part 2 - Number of safe reports with Problem Dampener: " + part2Result);
    }
}