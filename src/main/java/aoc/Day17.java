...
public class Day17 extends AoCSolution {
    ...
    public static void main(String[] args) {
        ...
        Day17 day = new Day17("src/main/resources/day17.txt");
...
class Computer {
    ...
    Pattern computerPattern = Pattern.compile(
        "Register A:\\s*(\\d+)\\s*Register B:\\s*(\\d+)\\s*Register C:\\s*(\\d+)\\s*Program:\\s*([\\d,]+)",
        Pattern.DOTALL
    );
        ...
        if (matcher.find()) {
            ...
            throw new IllegalArgumentException("Failed to parse computer instructions. Input:\n" + fullRawInput);
        }
        return computer;
    }
